...
"""
RAM Maximizing scheduler:
Tries to fit as many VMs possible on single host
"""
	...
	print "Instance props : ", request_spec['instance_properties']
        ...
        for num in xrange(num_instances):
            ...
            for whost in available_hosts:
                ...
                if (available_mem <= minval) and (available_mem >= requested_ram):
                    minval = available_mem
                    minindex = i
                i += 1

            if (minindex >= 0):
                weighed_hosts = [ available_hosts[minindex] ]
            else:
                weighed_hosts = []
